...
sshpass -p 123456789 ssh -o StrictHostKeyChecking jenkinsdeploy@51.254.127.173 "screen -X -S TipReportRestProduction quit"
sshpass -p 123456789 ssh -o StrictHostKeyChecking jenkinsdeploy@51.254.127.173 screen -S TipReportProduction 
sshpass -p 123456789 ssh -o StrictHostKeyChecking jenkinsdeploy@51.254.127.173 java -jar TipReportRest-1.0.jar S
'''
          }
        }
